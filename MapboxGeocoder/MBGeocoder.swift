...
open class Geocoder: NSObject {
    ...
    public init(accessToken: String?, host: String?) {
        print("⚠️ This application was linked against a build of MapboxGeocoder.swift that was built from the “swift3” branch of the mapbox/MapboxGeocoder.swift repository. Development of the Swift 3 version of MapboxGeocoder.swift has moved to the “master” branch. If you are integrating MapboxGeocoder.swift via CocoaPods or Carthage, please update your Podfile or Cartfile to require a specific commit on the “master” branch or the “master” branch itself. The “swift3” branch is no longer being updated and will soon be deleted.")
